...
const ProfileDropdown = ({ user }: { user: any }) => {
  ...
  return (
    <div ref={ref} className="relative hidden md:flex items-center gap-2.5">
      ...
      {open && (
        <div
          className="absolute right-0 top-12 w-52 bg-white rounded-2xl shadow-2xl border border-slate-100 overflow-hidden z-[500]"
        ...
        >
          ...
          {[
            ...
            <a
              key={l.label}
              href={l.href}
              className="block px-4 py-3 text-sm text-slate-600 hover:bg-blue-50/60 no-underline hover:text-[#1D4ED8] transition-colors"
            >
              {l.label}
            </a>
          ))}
...
const MegaDropdown: React.FC<{
  ...
  return (
    <div
      className={`absolute top-[calc(100%+6px)] left-0 bg-white rounded-2xl border border-slate-100 shadow-[0_20px_60px_rgba(29,78,216,0.12)] p-5 z-[300] grid gap-6
...
const NavLink: React.FC<{ item: NavItem }> = ({ item }) => {
  ...
  if (!item.columns) {
    return (
      <a
        href={item.href}
        className="flex items-center gap-1 px-3.5 py-2 text-sm font-semibold text-slate-700 rounded-lg transition-all hover:bg-blue-50 hover:text-[#1D4ED8] no-underline whitespace-nowrap"
      >
        {item.label}
      </a>
    );
  ...
  return (
    ...
    >
      <button
        className={`flex items-center gap-1 px-3.5 py-2 text-sm font-semibold rounded-lg border-none whitespace-nowrap transition-all font-[inherit] cursor-pointer
...
const PostFreeSheet = ({
  ...
  const verifyOtp = async () => {
    ...
    try {
      ...
      setErrors({
        otp: err?.response?.data?.message || err.message || "Invalid OTP",
      });
    } finally {
      setLoading(false);
    }
  ...
  return (
    <div className="fixed inset-0 z-[990] flex flex-col font-[DM_Sans,sans-serif]">
      ...
      <div
        className="absolute bottom-0 left-0 right-0 bg-white rounded-t-3xl max-h-[95vh] flex flex-col overflow-hidden"
            ...
            <div>
              <div className="flex items-center gap-2 mb-0.5">
                <div
                  ...
                  style={{
                    background:
                      "linear-gradient(135deg,#0B3C8C,#1E40AF,#3B82F6)",
                  }}
                >
                ...
                <span className="text-[9px] font-black bg-[#2563EB] text-white px-1.5 py-0.5 rounded">
                  FREE
                </span>
              </div>
              {step !== "success" && (
                  ...
                  {["Details", "Verify OTP", "Done!"].map((l, i) => {
                    ...
                    return (
                      <div key={l} className="flex items-center gap-1">
                        ...
                        <span
                          className={`text-[9px] font-bold ${i === cur ? "text-[#1E40AF]" : i < cur ? "text-emerald-600" : "text-slate-300"}`}
                        >
                          {l}
                        </span>
                        {i < 2 && (
                          <div
                            className={`w-4 h-px rounded ${i < cur ? "bg-emerald-400" : "bg-slate-200"}`}
                          />
                        )}
                      </div>
                    );
        ...
        >
          ...
          {step === "form" && (
            <div style={{ animation: "slideIn 0.25s ease both" }}>
              <h2 className="text-xl font-black text-[#1E40AF] mb-0.5">
                Sell or Rent <span className="text-emerald-600">FREE</span>
              </h2>
              <p className="text-slate-400 text-xs font-medium mb-4">
                No registration · Go live in 2 minutes
              </p>
              ...
              <div className="grid grid-cols-2 gap-2 mb-4">
                {PROPERTY_TYPES.map((t) => (
                  ...
                  >
                    ...
                    <div>
                      <p
                        className={`text-xs font-black leading-none ${propertyType === t.v ? "text-[#1D4ED8]" : "text-slate-700"}`}
                      >
                        {t.l}
                      </p>
              ...
              {/* City */}
              <div className="mb-3">
                <label className="text-[10px] font-black uppercase tracking-[0.15em] text-slate-500 block mb-1.5">
                ...
                <div className="relative">
                  <select
                    ...
                    className={`${inp(errors.city)} appearance-none pr-10 cursor-pointer`}
                    style={{ fontSize: "16px" }}
                  >
              ...
              <div className="mb-5">
                ...
                <div
                  className={`flex border-2 rounded-2xl overflow-hidden transition-all ${errors.phone ? "border-rose-400" : "border-slate-200 focus-within:border-[#2563EB]"}`}
                >
                  <div className="flex items-center gap-1.5 px-3 bg-slate-50 border-r border-slate-200 flex-shrink-0 text-sm font-black text-[#1E40AF]">
                    🇮🇳 +91
                  </div>
                  <input
                    type="tel"
                    ...
                    className="flex-1 px-3 py-3.5 text-sm text-[#1E40AF] bg-white outline-none"
                    style={{ fontSize: "16px" }}
                  />
                </div>
                {errors.phone && (
          ...
          {step === "otp" && (
            <div style={{ animation: "slideIn 0.25s ease both" }}>
              ...
              <h2 className="text-xl font-black text-[#1E40AF] mb-1">
                Verify Your Number
              </h2>
              <p className="text-slate-500 text-sm mb-4">
                OTP sent to{" "}
                <strong className="text-[#1E40AF]">+91 {phone}</strong>
              </p>

              {/* 6-Digit Responsive OTP */}
              ...
              {errors.otp && (
                <p className="text-rose-500 text-[11px] font-semibold text-center mb-3">
                  ⚠ {errors.otp}
                </p>
              )}
            ...
            >
              <div
                ...
                style={{
                  ...
                  animation:
                    "popBounce 0.6s cubic-bezier(0.34,1.56,0.64,1) both",
                }}
              >
                <svg
                  width="38"
              ...
              <h2 className="text-xl font-black text-[#1E40AF] mb-2">
                You're Verified! 🎉
              </h2>
              <p className="text-slate-500 text-sm mb-5 max-w-xs mx-auto leading-relaxed">
                Complete your full listing with photos & price to get{" "}
                <strong className="text-[#1E40AF]">5× more enquiries.</strong>
              </p>
              <div className="grid grid-cols-2 gap-2 mb-5 text-left">
                {[
                  ...
                  <div
                    key={l}
                    className="flex items-center gap-2 bg-blue-50/60 border border-blue-100 rounded-2xl p-3"
                  >
  ...
  return (
    <>
      ...
      <div className="font-[DM_Sans,sans-serif]">
        ...
        <div
          className="hidden md:block text-white/70 text-xs tracking-wide py-1.5"
          style={{
            background:
              "linear-gradient(90deg,#0B3C8C 0%,#1E40AF 50%,#2563EB 100%)",
          }}
        >
            ...
            <div className="flex gap-5 items-center">
              {["For Builders", "Advertise", "Download App"].map((t) => (
                <a
                  key={t}
                  href="#"
                  className="text-white/60 no-underline hover:text-blue-200 transition-colors"
                >
                  {t}
                </a>
              ))}
        ...
        <header className="bg-white shadow-[0_2px_20px_rgba(29,78,216,0.10)] sticky top-0 z-[100]">
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(90deg,#0B3C8C 0%,#1E40AF 40%,#2563EB 70%,#3B82F6 100%)",
            }}
          />
          ...
          <div className="max-w-[1280px] mx-auto px-3 md:px-6 flex items-center h-14 md:h-[68px] gap-2 md:gap-4">
            ...
            >
              <div
                ...
                style={{
                  background:
                    "linear-gradient(135deg,#0B3C8C 0%,#1E40AF 50%,#3B82F6 100%)",
                }}
              >
                <HomeIcon />
              </div>
            ...
            <div ref={cityRef} className="relative shrink-0 hidden lg:block">
              ...
              {cityOpen && (
                <div
                  className="absolute top-[calc(100%+6px)] left-0 bg-white border border-slate-100 rounded-2xl shadow-[0_12px_40px_rgba(29,78,216,0.12)] z-[300] overflow-hidden min-w-[160px]"
            ...
            <div className="flex items-center gap-1.5 md:gap-2 shrink-0">
              ...
              >
                ...
                <span className="bg-white text-[#1E40AF] text-[8px] md:text-[9px] font-black px-1.5 py-[2px] rounded-[3px]">
                  FREE
                </span>
              </a>
              ...
              >
                <span
                  className={`block w-5 h-0.5 bg-[#1E40AF] rounded-full transition-all duration-200 ${mobileOpen ? "translate-y-[7px] rotate-45" : ""}`}
                />
                <span
                  className={`block w-5 h-0.5 bg-[#1E40AF] rounded-full transition-all duration-200 ${mobileOpen ? "opacity-0" : ""}`}
                />
                <span
                  className={`block w-5 h-0.5 bg-[#1E40AF] rounded-full transition-all duration-200 ${mobileOpen ? "-translate-y-[7px] -rotate-45" : ""}`}
                />
          ...
          {mobileOpen && (
            <div
              className="lg:hidden bg-white border-t border-slate-100 overflow-y-auto overscroll-contain max-h-[88vh]"
            ...
            >
                  ...
                  <div key={item.label}>
                    {item.columns ? (
                      <>
                        ...
                        {mobileAccordion === item.label && (
                          <div
                            className="bg-blue-50/30 px-4 pb-4"
                            style={{ animation: "slideDown 0.15s ease" }}
                          >
                            {item.columns.map((col) => (
                              <div key={col.heading} className="mb-3">
                                <p className="text-[10px] font-black uppercase tracking-widest text-[#2563EB] mb-2 mt-3">
                                  {col.heading}
                                </p>
                      ...
                      <a
                        href={item.href || "#"}
                        className="flex justify-between items-center px-4 py-4 text-[15px] font-semibold text-slate-700 no-underline active:bg-slate-50"
                      >
                        {item.label}
                      </a>
                    )}
              ...
              <div className="px-4 pt-4 pb-6 pb-safe flex flex-col gap-3 border-t border-slate-100">
                ...
                {isAuthenticated ? (
                  ...
                  >
                    🏠 Post Property
                    <span className="bg-white text-[#1E40AF] text-[9px] font-black px-1.5 py-0.5 rounded">
                      FREE
                    </span>
                  </a>
                ) : (
