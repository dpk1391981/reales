  ...
  Spinner: ({ dark = false }: { dark?: boolean }) => (
    <svg className="animate-spin w-4 h-4" fill="none" viewBox="0 0 24 24">
      <circle
        ...
        cy="12"
        r="10"
        stroke={dark ? "#0f2342" : "white"}
        strokeWidth="4"
      />
      <path
        className="opacity-75"
        fill={dark ? "#0f2342" : "white"}
...
export default function Think4BuySaleLanding() {
  ...
  const resend = () => {
    setTimer(30); /* call send-otp API again */
  };
      ...
      <div className="min-h-screen mesh relative overflow-x-hidden">
        ...
        <header role="banner">
          ...
          >
            ...
            >
              <div
                className="w-9 h-9 rounded-xl flex items-center justify-center shadow-[0_4px_20px_rgba(245,158,11,0.5)]"
                style={{
              ...
              <span className="display text-base font-bold text-white">
                Think4BuySale<span className="text-amber-400">.in</span>
              </span>
            </a>
            ...
            <div className="grid lg:grid-cols-2 gap-10 lg:gap-20 items-center">
              ...
              <div className="order-1 lg:order-2 card-in">
                ...
                >
                  ...
                  <div
                    ...
                    style={{
                      background:
                        "linear-gradient(90deg,#0f2342 0%,#1a3a6e 25%,#f59e0b 60%,#10b981 100%)",
                    }}
                    aria-hidden
                  />
                        ...
                        (l, i) => {
                          ...
                          return (
                            ...
                            >
                              ...
                              <span
                                className={`hidden sm:block text-[10px] font-bold transition-colors ${active ? "text-[#0f2342]" : done ? "text-emerald-500" : "text-slate-300"}`}
                              >
                                {l}
                              </span>
                              {i < 2 && (
                  ...
                  <div className="px-6 pb-6 pt-4 md:px-8 md:pb-8">
                      ...
                      <div className="slide-in">
                          ...
                          >
                            {PROPERTY_TYPES.map((t) => (
                              ...
                              >
                                ...
                                <div>
                                  <p
                                    className={`text-xs font-black leading-none ${form.propertyType === t.v ? "text-[#0f2342]" : "text-slate-700"}`}
                                  >
                                    {t.l}
                                  </p>
                        ...
                        <div className="mb-3">
                          ...
                          {errors.city && (
                            <p
                              role="alert"
                              className="text-rose-500 text-[11px] font-semibold mt-1.5 flex items-center gap-1"
                            >
                              ⚠ {errors.city}
                            </p>
                          )}
                        ...
                        <button
                          ...
                          style={{
                            background:
                              "linear-gradient(135deg,#0b1d3a 0%,#0f2342 40%,#1e40af 100%)",
                            boxShadow:
                              "0 8px 32px rgba(15,35,66,0.45), 0 2px 0 rgba(255,255,255,0.05) inset",
                            WebkitTapHighlightColor: "transparent",
                          }}
                        >
                          {loading ? (
                        ...
                        <p className="text-center text-[10px] text-slate-400 mt-3 leading-relaxed">
                          ...
                          <a
                            href="/terms"
                            className="text-[#0f2342] font-bold hover:underline"
                          >
                            Terms
                          </a>{" "}
                          &amp;{" "}
                    ...
                    {step === "otp" && (
                      <div className="slide-in">
                        ...
                        <h2 className="display text-[22px] font-bold text-[#0f2342] mb-1">
                          Verify Your Number
                        </h2>
                        <p className="text-slate-500 text-sm mb-1">
                          OTP sent to{" "}
                          <strong className="text-[#0f2342] font-black">
                            +91 {form.phone}
                          </strong>
                        </p>
                        <button
                    ...
                    {step === "success" && (
                      <div className="slide-in text-center py-3">
                        ...
                        <h2 className="display text-2xl font-bold text-[#0f2342] mb-2">
                          You're Verified! 🎉
                        </h2>
                        <p className="text-slate-500 text-sm leading-relaxed mb-5 max-w-xs mx-auto">
                          Your enquiry details are saved. Complete your full
                          listing to get{" "}
                          <strong className="text-[#0f2342]">
                        ...
                        <div className="grid grid-cols-2 gap-2 mb-5 text-left">
                          {[
                            ...
                            <div
                              key={l}
                              className="flex items-center gap-2.5 bg-slate-50 border border-slate-100 rounded-2xl p-3"
                            >
                        ...
                        <button
                          ...
                          style={{
                            background:
                              "linear-gradient(135deg,#0b1d3a,#1e40af)",
              ...
              <div className="order-2 lg:order-1 text-white hero-in">
                ...
                <h2 className="display font-bold leading-[1.1] mb-5">
                  <span className="block text-[32px] md:text-[42px] lg:text-[50px] text-white">
                    Sell or Rent
                  </span>
                  <span className="block text-[32px] md:text-[42px] lg:text-[50px] text-white">
                    Your Property
                  ...
                  <span
                    ...
                    style={{
                      background:
                        "linear-gradient(90deg,#fcd34d,#f59e0b,#fb923c)",
                  ...
                  {FEATURES.map((f) => (
                    ...
                    >
                      <p
                        ...
                        style={{
                          animationDelay: `${FEATURES.indexOf(f) * 0.4}s`,
                        }}
                      >
                        {f.icon}
                      </p>
                ...
                <div>
                  ...
                  <div
                    className="glass rounded-2xl p-4 mb-3 transition-all duration-500"
                    key={testIdx}
                  >
                    ...
                    <div className="flex items-center gap-2.5">
                      <div
                        className="w-8 h-8 rounded-full flex-shrink-0 flex items-center justify-center font-black text-sm text-[#0f2342]"
                        style={{
          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              {[
                ...
                >
                  <div className="text-5xl mb-4 group-hover:scale-110 transition-transform duration-300 block">
                    {s.icon}
                  </div>
                  <div
                    className="w-7 h-7 rounded-full flex items-center justify-center text-[10px] font-black text-[#0f2342] mx-auto mb-3"
                    style={{
                      background: "linear-gradient(135deg,#fcd34d,#f59e0b)",
                    }}
                  >
